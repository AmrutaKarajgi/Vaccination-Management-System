...
public class Venue2 {
	...
	public void VaccinationAtVenue1() {
		System.out.println();
		System.out.println(" * * * * * *   Welcome To DGP Nagar Venue Of Vaccination centre  * * * * * * * * *");
		System.out.println();
		System.out.println("                      Available   Vaccine   :  Covaccine ");
						...
						for (int i = 1; i <= NewLogicOfQueue.Num_Dose; i++) {
							...
							if (age >= 55) {
								if (Slot1.count <= 5) {
									...
									System.out.println(
											" Sorry doses are over for this week Do check the avialabilty of the doses for the next week on upcomming sunday ");
									tokenNum--;
								}
							}
				...
				case 5:
					...
					if (NewLogicOfQueue.IsQueueEmpty(Slot1) && NewLogicOfQueue.IsQueueEmpty(Slot2)
						...
						if (NewLogicOfQueue.IsQueueEmpty(Slot3)) {
							...
							System.out.println(
									"-------- Those who have registered for this week has got Vaccinated --------- ");
						}
					}
					System.out.println(" ");
					System.out.println(" ");
